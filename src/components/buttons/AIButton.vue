...
<template>
  <div class="relative w-[70px] h-[70px] cursor-pointer">
    ...
    >
      <g id="ai">
        <g id="main" filter="url(#filter0_i)">
          <ellipse cx="195" cy="195.878" rx="90" ry="90" />
        </g>
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.467 0 0 0 0 0.722 0 0 0 0 0.969 0 0 0 0.06 0"
          />
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.467 0 0 0 0 0.722 0 0 0 0 0.969 0 0 0 0.77 0"
          />
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow" />
        </filter>
        <filter
    ...
    <span
      class="absolute left-[26px] top-[20px] text-white font-semibold cursor-pointer text-[18px]"
      >AI</span
    >
  </div>
</template>
