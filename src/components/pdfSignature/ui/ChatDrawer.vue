...
<template>
  <div>
    <n-popover placement="right" trigger="click" @update:show="openChat">
      <template #trigger>
        <div
          class="absolute bottom-[50px] right-[20px]"
          :class="chatCount > 0 && !store.chatVisible && 'shake-button'"
        >
...
<style scoped lang="scss">
  .shake-button {
    animation: shake-lr 1s cubic-bezier(0.455, 0.03, 0.515, 0.955) infinite;
  }
  @keyframes shake-lr {
    0%,
    100% {
