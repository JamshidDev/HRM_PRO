...
export const useMedInspectionStore = defineStore('medInspectionStore', {
  ...
  actions: {
    _index() {
      ...
      $ApiService.medInspectionService
        ._index({ params })
        .then((res) => {
    ...
    _polyclinics() {
      ...
      $ApiService.medInspectionService
        ._polyclinics({ params: { page: 1, per_page: 1000 } })
        .then((res) => {
    ...
    _myPolyclinics() {
      ...
      $ApiService.polyclinicService
        ._index({ params: { page: 1, per_page: 1000 } })
        .then((res) => {
