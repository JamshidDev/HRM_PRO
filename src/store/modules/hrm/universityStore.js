  ...
  actions: {
    ...
    _getUniversityList(infinity) {
      ...
      $ApiService.universityServiceAdmin
        ._index({ params: this.universityParam })
        .then((res) => {
    ...
    onScrollUniversity(e) {
      ...
      if (
        ...
        !this.universityLoading &&
        this.totalUniversity > this.universityList.length
      ) {
        this.universityParam.page += 1
    ...
    _getSpeciality(infinity = false) {
      ...
      $ApiService.specialityService
        ._index({ params: this.specialParam })
        .then((res) => {
    ...
    onScrollSpecial(e) {
      ...
      if (
        currentTarget.scrollTop + currentTarget.offsetHeight >= currentTarget.scrollHeight &&
        !this.specialityLoading &&
        this.totalSpecial > this.specialityList.length
      ) {
        this.specialParam.page += 1
