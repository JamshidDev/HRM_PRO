...
export const useWorkerImageStore = defineStore('workerImageStore', {
    ...
    actions: {
        _index() {
            this.loading = true
            $ApiService.workerImageService._index({params: this.params}).then((res) => {
        ...
        _create(){
            ...
            $ApiService.workerImageService._create({data:this.payload}).then(()=>{
                this.visible = false
                this._index()
                this.resetForm()
            }).finally(()=>{
        ...
        _update(){
            this.saveLoading = true
            $ApiService.workerImageService._update({id:this.elementId, data:this.payload}).then(()=>{
                this.visible = false
                this._index()
                this.resetForm()
            }).finally(()=>{
        ...
        _delete(){
            ...
            $ApiService.workerImageService._delete({id:this.elementId}).then(()=>{
                this._index()
            }).finally(()=>{
        ...
        _worker_photos(workerId = null){
            ...
            $ApiService.photoService._index({params:{worker_id:id}}).then((res)=>{
        ...
        updateStatus(data){
            ...
            $ApiService.workerImageService._confirm({data}).then(()=>{
                this.visible = false
                this._index()
            }).finally(()=>{
