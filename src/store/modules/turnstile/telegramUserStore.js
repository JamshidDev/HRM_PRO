...
export const useTelegramUserStore = defineStore('telegramUserStore', {
    ...
    actions: {
        _index() {
            this.loading = true
            $ApiService.telegramUserService._index({params: this.params}).then((res) => {
        ...
        _edit() {
            ...
            $ApiService.telegramUserService._edit({id:this.elementId}).then((res) => {
        ...
        _alLDevice() {
            ...
            $ApiService.telegramUserService._allDevices().then((res) => {
        ...
        _create(){
            ...
            $ApiService.telegramUserService._create({data}).then((res) => {
                this.visible = false
                this._index()
        ...
        _delete() {
            this.loading = true
            $ApiService.telegramUserService._delete({id: this.elementId}).then((res) => {
                this._index()
            }).finally(() => {
                this.loading = false
            })
        ...
        _users(infinity=false){
            ...
            $ApiService.telegramUserService._users({params}).then((res) => {
        ...
        _onScrollUser(e){
            ...
            if(currentTarget.scrollTop + currentTarget.offsetHeight >= currentTarget.scrollHeight && !this.userLoading && this.totalUserItem>this.userList.length){
                this.userParam.page +=1
                this._users(true)
            }
        },
