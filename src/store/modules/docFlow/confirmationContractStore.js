...
const {t} = i18n.global
export const useConfirmationContractStore = defineStore('confirmationContractStore', {
    state:()=>({
        list:[],
        loading:false,
        saveLoading:false,
    ...
    actions:{
        _index(){
            this.loading= true
            $ApiService.documentService._confirmationContract({params:this.params}).then((res)=>{
