...
export const useAIConversationStore = defineStore('AIConversationStore', {
  ...
  actions: {
    ...
    questions(infinity = false) {
      ...
      $ApiService.aiConversationService
        .questions({ params: this.questionParams })
        .then(async (res) => {
          let data = []
          ...
          this.scrollContainer.scrollTo({
            top: infinity
              ? this.scrollContainer.scrollHeight - this.scrollHeight
