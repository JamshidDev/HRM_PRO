...
export const usePublicStore = defineStore('usePublicStore', {
    ...
    actions:{
        _loginToSystem(){
            ...
            $ApiService.publicService._loginToSystem({data}).then((res)=>{
        ...
        _getDocument(callback){
            this.loading = true
            $ApiService.publicService._downloadDocument({id:this.elementId}).then((res)=>{
                this.isExist = true
        ...
        _getDetailExam(){
            ...
            $ApiService.publicService._getDetailExam({id:this.elementId, token}).then((res)=>{
