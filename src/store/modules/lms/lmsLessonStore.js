  ...
  actions: {
    ...
    _eduPlans() {
      ...
      $ApiService.eduPlanService
        ._index({ params: { page: 1, per_page: 1000, learning_center_id } })
        .then((res) => {
    ...
    _groups() {
      ...
      $ApiService.lmsGroupService
        ._index({ params: { page: 1, per_page: 1000, edu_plan_id } })
        .then((res) => {
