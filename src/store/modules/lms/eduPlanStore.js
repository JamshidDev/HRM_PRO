  ...
  actions: {
    _attachedWorkers() {
      ...
      $ApiService.eduPlanService
        ._attachWorkers({ id: this.elementId, params })
        .then((res) => {
    ...
    _detachWorkers(data) {
      ...
      $ApiService.eduPlanService
        ._detachWorkers({ id: this.elementId, data })
        .then((res) => {
    ...
    _specializations(infinite) {
      ...
      $ApiService.specializationService
        ._index({ params })
        .then((res) => {
    ...
    onScrollSpecializations(e) {
      ...
      if (
        ...
        !this.specializationsLoading &&
        this.specializationsTotal > this.specializations.length
      ) {
        this.specializationsParams.page += 1
    ...
    onScrollSubjects(e) {
      ...
      if (
        currentTarget.scrollTop + currentTarget.offsetHeight >= currentTarget.scrollHeight &&
        !this.subjectsLoading &&
        this.subjectsTotal > this.subjects.length
      ) {
        this.subjectsParams.page += 1
        this._subjects(true)
      }
