...
export const useExamVideoStore = defineStore('examVideoStore', {
    ...
    actions: {
        _start() {
            ...
            $ApiService.examVideoService._start({data}).then(async (res) => {
        ...
        _uploadFile() {
            ...
            axios.put(url, this.arrayBuffer, {
        ...
        _finishVideo() {
            ...
            $ApiService.examVideoService._finishVideo({data}).then((res) => {
                this.finishCallback?.()
            }).finally(() => {
        ...
        startCanvasDraw() {
            ...
            if (this.videoRef.readyState >= 2) {
                ctx.scale(-1, 1)
                ctx.drawImage(this.videoRef, -this.canvasRef.width, 0, this.canvasRef.width, this.canvasRef.height)
            }
