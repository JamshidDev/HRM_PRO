...
const _dashboardChart =async (payload)=>{
    return await axios.get(`/v1/turnstile/hik-central/dashboard/daily-attendance`, {params:payload?.params})
}
...
const _dashboardStat =async (payload)=>{
    return await axios.get(`/v1/turnstile/hik-central/dashboard/worker-stats`, {params:payload?.params})
}
