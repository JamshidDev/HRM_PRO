...
const _HKShow = async (payload) => {
  return await axios.get(`/v1/turnstile/hik-central/work-durations/${payload.id}`, {
    params: payload.params
  })
}
const _HKShowEventsInDay = async (payload) => {
  return await axios.get(`/v1/turnstile/hik-central/work-durations/${payload.id}/events`, {
    params: payload.params
  })
}
