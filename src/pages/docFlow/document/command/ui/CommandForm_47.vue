...
<template>
  ...
  >
    ...
    <div class="col-span-12 md:col-span-6 lg:col-span-6">
      <n-form-item :label="$t(`content.type`)" path="type" :rule-path="validationRules.rulesNames.requiredNumberField">
        <n-select
            filterable
            :options="options"
    ...
    <div class="col-span-12 md:col-span-6 lg:col-span-3">
      ...
      >
        <n-input :disabled="true" class="!w-full" type="text" v-model:value="store.form_47.vacation_reason_day" />
      </n-form-item>
    </div>
    <div class="col-span-12 md:col-span-6 lg:col-span-3">
      <n-form-item
