...
<template>
  ...
  >
    ...
    <div class="col-span-12 md:col-span-6 lg:col-span-6">
      <n-form-item :label="$t(`content.workTime`)" path="vacation_finish_status" :rule-path="validationRules.rulesNames.requiredNumberField">
        <n-select
            filterable
    ...
    <div v-if="store.form_50.vacation_finish_status === 1" class="col-span-12 md:col-span-6 lg:col-span-6">
    ...
    <div v-if="store.form_50.vacation_finish_status === 2" class="col-span-12 md:col-span-6 lg:col-span-6">
      <n-form-item :label="$t(`documentPage.command.form.deadlineOfVacation`)" path="child_age" :rule-path="validationRules.rulesNames.requiredNumberField">
        <n-select
            filterable
            :options="ageOptions"
