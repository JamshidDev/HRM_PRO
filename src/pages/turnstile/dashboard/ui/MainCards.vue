...
<template>
  <div class="mt-4">
    ...
    >
      <div @click="onPreview('late_workers')" class="col-span-12 md:col-span-6 xl:col-span-3 border border-surface-line hover-effect-card px-4 py-2 rounded-xl bg-surface-section h-[100px] relative">
      ...
      <div @click="onPreview('absent_workers')" class="col-span-12 md:col-span-6 xl:col-span-3 border border-surface-line hover-effect-card px-4 py-2 rounded-xl bg-surface-section h-[100px] relative">
        <div class="flex flex-col mb-2">
      ...
      <div @click="onPreview('early_leave_workers')" class="col-span-12 md:col-span-6 xl:col-span-3 border border-surface-line hover-effect-card px-4 py-2 rounded-xl bg-surface-section h-[100px] relative">
        <div class="flex flex-col mb-2">
      ...
      <div @click="onPreview('work_hours')" class="col-span-12 md:col-span-6 xl:col-span-3 border border-surface-line hover-effect-card px-4 py-2 rounded-xl bg-surface-section h-[100px] relative">
        <div class="flex flex-col mb-2">
