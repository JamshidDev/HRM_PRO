      ...
      <n-spin :show="store.workTimeLoading" class="col-span-12">
        <div class="grid grid-cols-12">
          ...
          <div class="col-span-5">
            ...
            <div @click="emits('onPreview', 'early_leave')" class="flex gap-2 items-center mt-4 bg-transparent hover:bg-primary/6 transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl relative group">
              ...
              <div class="w-[32px] h-[32px] bg-warning/10 rounded-lg flex opacity-100 group-hover:opacity-[0.2] transition-all duration-300">
                <n-icon size="24" class="text-warning m-auto">
                  <ClockToolbox20Regular/>
                </n-icon>
              </div>
              <div class="leading-1 opacity-100 group-hover:opacity-[0.2] transition-all duration-300">
                <h4 class="text-lg text-textColor0 font-bold leading-[1.2]">{{earlyGoCount}}</h4>
                <small class="text-secondary text-xs leading-[1.2]">{{$t('turnStileDashboard.cards.earlyGo')}}</small>
              </div>
            </div>

            <div @click="emits('onPreview', 'late_come')" class="flex gap-2 items-center mt-4 bg-transparent hover:bg-primary/6 transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl relative group">
              <div class="transition-all duration-500 scale-0   absolute left-1/2 top-1/2 -translate-1/2 text-xs font-medium text-primary opacity-0 group-hover:opacity-100 group-hover:scale-100">
                <n-icon size="36">
                  <Eye20Filled/>
                </n-icon>
              ...
              <div class="w-[32px] h-[32px] bg-danger/10 rounded-lg flex opacity-100 group-hover:opacity-[0.2] transition-all duration-300">
