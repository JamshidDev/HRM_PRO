  ...
  <n-spin :show="store.mainChartLoading">
    <div class="p-2 flex flex-col">
      ...
      <div class="flex gap-6 mt-10">
        ...
        <div class="flex gap-4 items-center">
          <div @click="emits('onPreview', 'not_come')" class="bg-transparent hover:bg-primary/6 transition-all duration-300 cursor-pointer p-2 rounded-xl relative group">
            <div class="transition-all duration-500 scale-0   absolute left-1/2 top-1/2 -translate-1/2 text-xs font-medium text-primary opacity-0 group-hover:opacity-100 group-hover:scale-100">
              <n-icon size="36">
                <Eye20Filled/>
              </n-icon>
            ...
            <div class="flex items-center gap-2 opacity-100 group-hover:opacity-[0.2] transition-all duration-300">
              <div class="bg-danger/10 w-[20px] h-[20px] flex justify-center items-center rounded-lg">
