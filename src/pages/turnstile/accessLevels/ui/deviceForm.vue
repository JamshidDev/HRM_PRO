      ...
      <div class="h-[calc(100vh-200px)] overflow-auto mt-2 px-2">
        <div class="grid grid-cols-12 gap-2 gap-y-2">
          <template v-for="item in store.onlineDeviceList" :key="item.id">
            <div
              class="col-span-12 md:col-span-4 flex flex-col bg-surface-ground/30 border border-surface-line px-4 py-2 rounded-lg"
            >
              <span
              ...
              >
                <span class="relative flex size-3">
                  <span
                    :class="[item.status === 1 ? 'animate-ping bg-success/90' : 'bg-danger/90']"
