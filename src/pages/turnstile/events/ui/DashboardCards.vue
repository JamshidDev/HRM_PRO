...
<template>
  <div class="mt-4">
    <div class="w-full grid grid-cols-12 gap-x-4 border-dashed border-surface-line rounded-xl"
         :class="[store.detailShow && ' border']"
    >
      <div class="col-span-3 border border-surface-line px-4 py-2 rounded-lg bg-surface-section">
