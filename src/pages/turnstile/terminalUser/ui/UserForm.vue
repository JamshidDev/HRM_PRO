...
<template>
  <div class="w-full h-[calc(100vh-200px)] overflow-y-auto">
    ...
    >
      ...
      <n-form-item
        ...
        path="last_name"
      >
        <n-input class="w-full" type="text" v-model:value="store.userPayload.last_name" />
      </n-form-item>
      <n-form-item
        class="col-span-12 md:col-span-6 lg:col-span-4"
        ...
        path="first_name"
      >
        <n-input class="w-full" type="text" v-model:value="store.userPayload.first_name" />
      </n-form-item>
      <n-form-item
        class="col-span-12 md:col-span-6 lg:col-span-4"
        ...
        path="middle_name"
      >
        <n-input class="w-full" type="text" v-model:value="store.userPayload.middle_name" />
      </n-form-item>
      <n-form-item
        class="col-span-12 md:col-span-6 lg:col-span-4"
      ...
      <n-form-item
        ...
        path="address"
      >
        <n-input class="w-full" type="text" v-model:value="store.userPayload.address" />
      </n-form-item>
      <n-form-item
        class="col-span-12 md:col-span-6 lg:col-span-4"
      ...
      <PhoneForm class="col-span-12" v-model:phones="store.userPayload.phones" />
    </n-form>
  </div>
  <div class="flex gap-4">
    <n-button
      ...
      class="!w-1/2"
      @click="store.addVisible = false"
      type="error"
      ghost
    >
      {{ $t('content.cancel') }}
    </n-button>
    <n-button class="!w-1/2" :loading="store.userLoading" type="primary" @click="onSubmit">
      {{ $t('content.save') }}
    </n-button>
  </div>
</template>
