    ...
    <n-spin :show="store.workerLoading">
      <div
        ...
        <div class="no-selectable-item schedule-header-row flex z-[202] w-fit min-w-full sticky top-0">
          <div class="font-bold flex justify-center items-center rounded-tl-lg border-r border-t border-l border-b border-surface-line p-2 w-[60px] min-w-[60px] h-[50px] sticky left-0 top-0 z-[20] bg-surface-section flex-shrink-0">
            #
          </div>
          ...
          <div class="rounded-tr-lg border-r border-t border-l border-b -ml-[1px] font-bold text-xs text-white flex justify-center items-center p-2 border-surface-line w-[80px] min-w-[80px] h-[50px] sticky right-0 top-0 bg-secondary flex-shrink-0 z-[20]">
...
<!--              @contextmenu="handleContextMenu($event,worker.index, dayIndex)"-->
            ...
            <div class="no-selectable-item border-r font-bold border-l border-t -ml-[1px] border-surface-line  w-[80px] min-w-[80px] h-[50px] sticky right-0 bg-[#ECEFF3] flex-shrink-0 z-[200]">
