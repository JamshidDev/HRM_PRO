    ...
    <div class="col-span-12">
      ...
      >
        <template #filterAction>
          ...
          <div class="w-[300px]">
            <label class="text-textColor3 ml-1">{{
              $t('turnstile.workDurationPage.startTime')
            }}</label>
            <n-input
              v-mask="'##:##'"
              class="w-full"
    ...
    <div class="col-span-12">
      <n-spin :show="store.lateLoading" style="min-height: 200px">
        <div class="w-full mt-4 h-[calc(100vh-260px)] overflow-x-auto">
          <n-table v-if="store.lateList.length > 0" :single-line="false" size="small">
            <thead>
              <tr>
              ...
              <tr v-for="(item, idx) in store.lateList" :key="idx">
                <td>
                  <span class="text-center block">{{
                    (store.lateParams.page - 1) * store.lateParams.per_page + idx + 1
                  }}</span>
                </td>
                <td>
                  <div>
                ...
                <td>
                  <div class="text-center">{{ item.event_time }}</div>
                </td>
              </tr>
            </tbody>
          </n-table>
