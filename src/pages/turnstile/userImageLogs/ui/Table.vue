...
import {useUserImageLogsStore} from "@/store/modules/index.js"
...
const statusTypes = {
  'create': {
    name: t('userImageLogs.status.create'),
    type: 'success',
    id:3,
  },
  'update': {
    name: t('userImageLogs.status.update'),
    type: 'warning',
    id:9,
  },
  'delete': {
    name: t('userImageLogs.status.delete'),
    type: 'error'
  }
}
</script>
      ...
      <div class="w-full overflow-y-auto mt-4">
        ...
        >
          ...
          <tr>
            ...
            <th class="min-w-[200px] w-[400px]">{{$t('content.responsible')}}</th>
            <th class="min-w-[100px] w-[140px] !text-center">{{$t('userImageLogs.status.title')}}</th>
          ...
          <tr v-for="(item, idx) in store.list" :key="idx">
            ...
            <td class="!text-center">
              <UIStatus :status="statusTypes[item.status]"/>
            </td>
            <td>
              <div>
                <UIUser
            ...
            <td class="!text-center">
              <UIBadge :show-icon="false" :label="Utils.timeWithMonth(item.created_at)" />
            </td>
          </tr>
          </tbody>
        </n-table>
