...
<template>
  <n-form ref="formRef" :rules="validationRules.common" :model="store.payload">
    <div class="h-[calc(100vh-160px)] overflow-y-auto">
      ...
      <div
        class="grid grid-cols-12 gap-x-2 border border-dashed border-surface-line rounded-2xl p-2 pb-0 mb-4"
      >
        ...
        >
          <n-input v-model:value="store.payload.external_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.external_salary_fund" />
        </n-form-item>
      </div>
      ...
      >
        ...
        <n-form-item
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_society_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_society_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_own_use_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_own_use_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_foreign_company_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.capital_foreign_company_salary_fund" />
        </n-form-item>
      </div>
      ...
      >
        ...
        <n-form-item
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_society_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_society_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_own_use_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_own_use_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_foreign_company_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.construction_foreign_company_salary_fund" />
        </n-form-item>
      </div>
      ...
      >
        ...
        <n-form-item
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_own_use_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_own_use_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_foreign_company_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_foreign_company_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_society_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.other_society_salary_fund" />
        </n-form-item>
      </div>

      <div
        class="grid grid-cols-12 gap-x-2 border border-dashed border-surface-line rounded-2xl p-2 pb-0 mb-10"
      >
        ...
        <n-form-item
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.temporary_contract_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.temporary_contract_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.civil_contract_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.civil_contract_salary_fund" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.freelancer_worker_count" />
        </n-form-item>
        <n-form-item
          class="col-span-12 md:col-span-6 lg:col-span-3"
          ...
          :rule-path="validationRules.rulesNames.requiredStringField"
        >
          <n-input v-model:value="store.payload.freelancer_salary_fund" />
        </n-form-item>
      </div>
    </div>
