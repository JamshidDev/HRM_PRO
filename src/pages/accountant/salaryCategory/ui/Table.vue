    ...
    <div class="w-full mt-4 overflow-y-auto h-[calc(100vh-200px)]">
      ...
      >
        <thead>
          ...
          <tr>
            <th colspan="2" class="w-[100px] !font-normal">
            ...
            <th colspan="2" class="!font-normal">{{ $t('salaryCategory.label.forForeign') }}</th>
            <th colspan="2" class="!font-normal !text-wrap leading-[1.2] !text-center">
            ...
            <th colspan="2" class="!border-r !text-wrap leading-[1.2] !text-center">
            ...
            <tr class="!text-right">
              <td>
                <div class="flex items-center justify-center">
                  <span
                    class="px-2 py-1 text-secondary bg-surface-ground/50 rounded-lg capitalize"
                    >{{ item.month }}</span
                  >
                </div>
              </td>
              ...
              <td>
                <template v-if="item.data">
                  <UIMenuButton @selectEv="onSelect" show-edit :data="item" />
                </template>
              </td>
            </tr>
          </template>
