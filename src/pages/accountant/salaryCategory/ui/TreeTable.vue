        ...
        <thead>
          <tr>
            <th
              rowspan="3"
              colspan="4"
              class="min-w-[400px] w-[400px] !text-center sticky-element !left-0"
            >
            ...
            <th
              colspan="2"
              rowspan="2"
              class="min-w-[100px] w-[100px] !text-center sticky-element !left-[400px]"
            >
              {{ $t('salaryCategory.label.all') }}
            </th>
            <th rowspan="2" colspan="2" class="min-w-[100px] w-[100px] !text-center">
              {{ $t('salaryCategory.label.external') }}
            </th>
            <th colspan="6" class="min-w-[100px] w-[100px] !text-center">
              {{ $t('salaryCategory.label.capital') }}
            </th>
            <th colspan="6" class="min-w-[100px] w-[100px] !text-center">
              {{ $t('salaryCategory.label.construction') }}
            </th>
            <th colspan="6" class="min-w-[100px] w-[100px] !text-center">
              {{ $t('salaryCategory.label.other') }}
            </th>
            <th colspan="6" class="min-w-[100px] w-[100px] !text-center">
              {{ $t('salaryCategory.label.fromIt') }}
            </th>
          </tr>
          <tr>
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forOrganization') }}
            </th>
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forOwn') }}
            </th>
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forForeign') }}
            </th>
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forOrganization') }}
            </th>
            ...
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forLogistic') }}
            </th>
            <th colspan="2" class="min-w-[100px] w-[100px] !font-normal">
              {{ $t('salaryCategory.label.forForeign') }}
            </th>
            <th
              colspan="2"
              class="min-w-[100px] w-[100px] !font-normal !text-wrap leading-[1.2] !text-center"
            >
              {{ $t('salaryCategory.label.forOther') }}
            </th>
            <th
              colspan="2"
              class="min-w-[100px] w-[100px] !font-normal !text-wrap leading-[1.2] !text-center"
            >
              {{ $t('salaryCategory.label.fixed-term') }}
            </th>
            <th
              colspan="2"
              class="min-w-[100px] w-[100px] !font-normal !text-wrap leading-[1.2] !text-center"
            >
              {{ $t('salaryCategory.label.contract') }}
            </th>
            <th
              colspan="2"
              class="min-w-[100px] w-[100px] !border-r !text-wrap leading-[1.2] !text-center"
            >
              {{ $t('salaryCategory.label.Housekeeper') }}
            </th>
          </tr>
          <tr>
            <th
              class="min-w-[140px] w-[140px] !text-wrap leading-[1.2] !font-normal text-xs !text-center !border-r sticky-element !left-[400px]"
            >
              {{ $t('salaryCategory.label.mediumWorkerCount') }}
            </th>
            <th
              class="min-w-[140px] w-[140px] !text-wrap leading-[1.2] !font-normal text-xs !text-center !border-r sticky-element !left-[540px]"
            >
