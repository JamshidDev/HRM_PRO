    ...
    <template v-if="store.applicationData">
      ...
      >
        <div class="col-span-12 mb-10">
          <h2 class="text-center text-3xl font-bold uppercase mt-4 text-primary">
            {{ $t('applicationPage.client.name') }}
          </h2>
        </div>
        <div class="col-span-12">
          <div
            class="grid grid-cols-12 border border-surface-line rounded-md border-dashed p-4 mb-16"
          >
        ...
        <n-form-item
          ...
          path="last_name"
        >
          <n-input class="w-full" type="text" v-model:value="store.form.last_name" />
        </n-form-item>
        <n-form-item
          class="col-span-4"
          ...
          path="first_name"
        >
          <n-input class="w-full" type="text" v-model:value="store.form.first_name" />
        </n-form-item>
        <n-form-item
          class="col-span-4"
          ...
          path="middle_name"
        >
          <n-input class="w-full" type="text" v-model:value="store.form.middle_name" />
        </n-form-item>
        <n-form-item
          class="col-span-4"
        ...
        <n-form-item class="col-span-4" :label="$t(`createWorkerPage.form.city`)" path="city_id">
          <n-select
        ...
        <n-form-item class="col-span-4" :label="$t(`createWorkerPage.form.address`)" path="address">
          <n-input class="w-full" type="text" v-model:value="store.form.address" />
        </n-form-item>
        <n-form-item
          class="col-span-4"
        ...
        <n-form-item class="col-span-4" :label="$t(`createWorkerPage.form.pin`)" path="pin">
          <n-input
            class="w-full"
            type="text"
        ...
        <n-form-item class="col-span-4" :label="$t(`createWorkerPage.form.inn`)" path="inn">
          <n-input
            class="w-full"
            type="text"
            v-mask="`#########`"
        ...
        <div class="col-span-12">
          ...
          <PhoneForm :phones="store.form.phones" />
        </div>

        <div class="col-span-12 p-6">
          <Signature @on-submit="onSubmit" ref="signatureRef" :is-check="true" />
        </div>
      </n-form>
    </template>
  </div>
