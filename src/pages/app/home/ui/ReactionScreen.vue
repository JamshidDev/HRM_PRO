<template>
  <div
    class="fixed top-0 left-0 bottom-0 right-0 w-full h-screen overflow-hidden pointer-events-none"
  >
    <span
      v-for="e in emojis"
      :key="e.id"
    ...
    >
      ...
      <span
        class="label px-2 py-0.5 bg-dark/60 text-white text-xs rounded-full whitespace-nowrap backdrop-blur-sm"
      >
        {{ e.label }}
      </span>
    </span>
