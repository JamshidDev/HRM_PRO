...
<template>
  <div
    class="w-[120px] h-[160px] select-none rounded-xl bg-linear-to-t from-blue-100 to-80% cursor-pointer to-primary top-1/2 -translate-y-1/2 absolute left-4 z-10 flex justify-center items-center"
  >
    <img
    ...
    <div
      @click="openCropper()"
      class="w-[36px] h-[36px] bg-blue-400 absolute rounded-full bottom-1 -right-4 flex justify-center items-center shadow"
    >
