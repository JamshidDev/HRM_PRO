...
<template>
  <div style="height: calc(100vh - 120px)" class="overflow-y-auto">
    <n-form ref="formRef" :rules="validationRules.partyPage" :model="store.payload">
      ...
      <n-form-item :label="$t(`partyPage.form.from_date`)" path="from_date">
        <n-date-picker
          class="w-full"
      ...
      <n-form-item :label="$t(`partyPage.form.to_date`)" path="to_date">
        <n-date-picker
          class="w-full"
