...
<template>
  <n-spin :show="store.passportLoading">
    <div
      class="grid grid-cols-12 mb-16 mt-16 gap-x-4 border border-dashed border-surface-line p-4 rounded-2xl"
    >
      ...
      <template v-for="(item, idx) in store.passportList" :key="idx">
        <div class="col-span-12 md:col-span-6 flex flex-col">
          ...
          <n-form-item
            ...
            path="address"
          >
            <n-input class="w-full" type="text" v-model:value="item.address" />
          </n-form-item>
        </div>
