...
<template>
  <div style="height: calc(100vh - 120px)" class="overflow-y-auto">
    <n-form ref="formRef" :rules="validationRules.militaryPage" :model="store.payload">
      ...
      <n-form-item :label="$t(`militaryPage.form.name`)" path="name">
        <n-input type="textarea" autosize v-model:value="store.payload.name" />
      </n-form-item>
      <n-form-item :label="$t(`militaryPage.form.number`)" path="number">
        <n-input type="textarea" autosize v-model:value="store.payload.number" />
      </n-form-item>
      <n-form-item :label="$t(`militaryPage.form.speciality`)" path="speciality">
        <n-input type="textarea" autosize v-model:value="store.payload.speciality" />
      </n-form-item>
      <n-form-item :label="$t(`militaryPage.form.commissariat`)" path="commissariat">
        <n-input type="textarea" autosize v-model:value="store.payload.commissariat" />
      </n-form-item>
    </n-form>
  </div>
