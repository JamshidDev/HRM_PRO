...
<template>
  <div style="height: calc(100vh - 120px)" class="overflow-y-auto">
    <n-form ref="formRef" :rules="validationRules.academicTitlePage" :model="store.payload">
      ...
      <UIUpload :showDelete="false" :multiple="false" v-model:files="store.payload.file" />
    </n-form>
  </div>
