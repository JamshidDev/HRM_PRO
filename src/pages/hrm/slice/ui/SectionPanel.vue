...
<template>
  <div
    ref="elementRef"
    :style="style"
    class="border border-surface-line box-element bg-surface-section rounded-lg overflow-hidden basis-[100px] grow shrink cursor-pointer select-none"
  >
    <div
      class="flex w-full px-2 items-center justify-between gap-2 sticky top-0 bg-surface-section z-10 pt-2"
    >
