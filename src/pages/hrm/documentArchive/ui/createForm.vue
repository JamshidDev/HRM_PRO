  ...
  <n-form ref="formRef" :rules="validationRules.documentArchive" :model="store.payload">
    <div style="min-height: calc(100vh - 120px)">
      ...
      <n-form-item :label="$t(`documentArchive.form.title`)" path="title">
        <n-input v-model:value="store.payload.title" type="text" />
      </n-form-item>
      <n-form-item :label="$t(`documentArchive.form.description`)" path="description">
        <n-input v-model:value.trim="store.payload.description" type="textarea" />
      </n-form-item>
      <n-form-item :label="$t(`documentArchive.form.visibility_type`)" path="visibility_type">
        <n-select
