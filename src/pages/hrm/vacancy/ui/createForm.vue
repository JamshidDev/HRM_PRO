    ...
    <div style="height: calc(100vh - 120px)" class="overflow-x-hidden overflow-y-auto">
      <div class="grid grid-cols-12">
        <div class="col-span-12">
          <div
            class="grid grid-cols-12 gap-x-2 border border-surface-line p-4 rounded-2xl border-dashed mb-4 bg-surface-ground"
          >
            <n-form-item
            ...
            <n-form-item
              ...
              :rule-path="validationRules.rulesNames.requiredStringField"
            >
              <n-input class="w-full" type="text" v-model:value="store.payload.rate" />
            </n-form-item>
            <n-form-item
              class="w-full col-span-3"
            ...
            <n-form-item
              ...
              :rule-path="validationRules.rulesNames.requiredStringField"
            >
              <n-input class="w-full" type="text" v-model:value="store.payload.experience" />
            </n-form-item>
            <n-form-item
              class="w-full col-span-3"
        ...
        <div
          class="col-span-12 border border-dashed border-surface-line p-4 rounded-2xl bg-surface-ground/30 mb-6"
        >
          <div class="grid grid-cols-12">
            <UIEditor
