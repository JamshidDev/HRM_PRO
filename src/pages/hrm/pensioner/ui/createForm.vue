...
<template>
  <div class="w-full h-[calc(100vh-200px)] overflow-y-auto">
    ...
    >
      ...
      <n-form-item
        ...
        path="position"
      >
        <n-input class="w-full" type="text" v-model:value="store.payload.position" />
      </n-form-item>
      ...
      <n-form-item
        ...
        path="year"
      >
        <n-date-picker class="w-full disable-mask" v-model:value="store.payload.year" type="year" />
      </n-form-item>
      <n-form-item
        class="col-span-12 md:col-span-6 lg:col-span-4"
  ...
  <div class="flex gap-4">
    ...
    <n-button class="!w-1/2" :loading="store.saveLoading" type="primary" @click="onSubmit">
      {{ $t('content.save') }}
    </n-button>
  </div>
</template>
