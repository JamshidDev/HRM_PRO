  ...
  <n-tabs type="segment" default-value="view" class="h-full">
            ...
            <template v-for="(item, idx) in store.list" :key="idx">
              ...
              <div class="flex gap-2 p-1 items-center">
                ...
                <n-tooltip trigger="hover">
                  {{ $t('content.delete') }}
                  <template #trigger>
                    <n-button dashed size="tiny" type="error" @click="() => store._delete(item.id)">
                      <template #icon>
    ...
    <n-tab-pane name="edit" class="h-full" :tab="$t('content.edit')">
      ...
      >
          ...
          >
            ...
            <div class="flex grow group justify-between">
              <div class="flex gap-4 items-center">
                <n-badge
                  :show="item.id === store.payload.mainUser"
        ...
        <div class="mt-auto">
          <n-button :loading="store.saveLoading" block type="primary" @click="onSubmit">
            {{ $t('content.save') }}
          </n-button>
        </div>
      </n-form>
