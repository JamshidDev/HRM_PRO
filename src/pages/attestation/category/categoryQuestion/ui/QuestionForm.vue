        ...
        :extra-rules="[
          {
            ...
            validator() {
              return store.payload.options.length < 3
                ? new Error($t('questionPage.rules.minOptions'))
                : true
            }
          }
        ]"
          ...
          :rule="[
            {
              ...
              validator() {
                ...
                return store.payload.options.length > 2 && !check
                  ? new Error($t('questionPage.rules.chooseCorrectAnswer'))
                  : true
              }
            }
          ]"
