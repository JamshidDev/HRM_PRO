...
<template>
  <n-form ref="formRef" :rules="validationRules.workdayPage" :model="store.payload">
    <div style="min-height: calc(100vh - 120px)">
      ...
      <n-form-item :label="$t(`workdayPage.form.day_of_week`)" path="day_of_week">
        <n-input type="text" v-model:value="store.payload.day_of_week" />
      </n-form-item>
      <n-form-item :label="$t(`workdayPage.form.start_time`)" path="start_time">
        <n-time-picker class="w-full" v-model:value="store.payload.start_time" />
      </n-form-item>
      <n-form-item :label="$t(`workdayPage.form.end_time`)" path="end_time">
        <n-time-picker class="w-full" v-model:value="store.payload.end_time" />
      </n-form-item>
    </div>
