...
export const ENFORCED = new Set([
  ...
  'hr-vacation-schedule-delete', 'hr-vacation-schedule-read', 'hr-vacation-schedule-write', 'hr-vacations-read', 'hr-vacations-write', 'hr-worker-applications-read',
  'hr-worker-applications-write', 'hr-workers-delete', 'hr-workers-read', 'hr-workers-write', 'hr-zoom-write', 'instructions',
  'instructions-delete', 'instructions-write', 'integration', 'integration-clients-delete', 'integration-clients-read', 'integration-clients-write',
  'languages-delete', 'languages-write', 'learning-centers-delete', 'learning-centers-write', 'lms-certificate-delete', 'lms-certificate-read',
  'lms-certificate-write', 'lms-direction-delete', 'lms-direction-read', 'lms-direction-write', 'lms-edu-plan-delete', 'lms-edu-plan-read',
  'lms-edu-plan-write', 'lms-lessons-delete', 'lms-lessons-read', 'lms-lessons-write', 'lms-specialization-delete', 'lms-specialization-read',
  'lms-specialization-write', 'lms-subjects-delete', 'lms-subjects-read', 'lms-subjects-write', 'lms-teachers-delete', 'lms-teachers-read',
  'lms-teachers-write', 'log-viewer-read', 'mobile-stories-delete', 'mobile-users-read', 'nationalities-delete', 'nationalities-write',
...
export const MEANINGFUL = new Set([
  ...
  'hr-zoom-write', 'instructions', 'instructions-delete', 'instructions-read', 'instructions-write', 'integration',
