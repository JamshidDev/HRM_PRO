...
export const ENFORCED = new Set([
  ...
  'hr-report-export-delete', 'hr-table-delete', 'hr-table-read', 'hr-table-write', 'hr-users-read', 'hr-users-write',
  'hr-vacation-schedule-delete', 'hr-vacation-schedule-read', 'hr-vacation-schedule-write', 'hr-vacations-read', 'hr-worker-applications-read', 'hr-worker-applications-write',
  'hr-workers-delete', 'hr-workers-read', 'hr-workers-write', 'hr-zoom-read', 'instructions', 'instructions-delete',
  'instructions-write', 'integration', 'integration-clients-delete', 'integration-clients-read', 'integration-clients-write', 'languages-delete',
  'languages-write', 'learning-centers-delete', 'learning-centers-write', 'lms-certificate-delete', 'lms-certificate-read', 'lms-certificate-write',
  'lms-direction-delete', 'lms-direction-read', 'lms-direction-write', 'lms-edu-plan-delete', 'lms-edu-plan-read', 'lms-edu-plan-write',
  'lms-lessons-delete', 'lms-lessons-read', 'lms-lessons-write', 'lms-specialization-delete', 'lms-specialization-read', 'lms-specialization-write',
  'lms-subjects-delete', 'lms-subjects-read', 'lms-subjects-write', 'lms-teachers-delete', 'lms-teachers-read', 'lms-teachers-write',
  'log-viewer-read', 'mobile-stories-delete', 'mobile-users-read', 'nationalities-delete', 'nationalities-write', 'organization-services-write',
  'organizations-delete', 'organizations-write', 'permissions-delete', 'permissions-read', 'permissions-write', 'positions-delete',
  'positions-write', 'quotes-delete', 'quotes-write', 'regions-delete', 'regions-write', 'roles-delete',
  'roles-read', 'roles-write', 'schedules-delete', 'schedules-write', 'specialities-delete', 'specialities-write',
  'telegram-read', 'telegram-write', 'turnstile-absent-workers-export', 'turnstile-approve-delete', 'turnstile-approve-read', 'turnstile-approve-write',
  'turnstile-building-delete', 'turnstile-building-read', 'turnstile-building-write', 'turnstile-devices-delete', 'turnstile-devices-read', 'turnstile-devices-write',
  'turnstile-hik-central-tg-user-delete', 'turnstile-hik-central-tg-user-read', 'turnstile-hik-central-tg-user-write', 'turnstile-hik-central-workers-delete', 'turnstile-hik-central-workers-read', 'turnstile-hik-central-workers-write',
  'turnstile-hik-central-sync-read', 'turnstile-hik-central-sync-write',
  'turnstile-sheets-delete', 'turnstile-sheets-groups-delete', 'turnstile-sheets-groups-read', 'turnstile-sheets-groups-write', 'turnstile-sheets-read', 'turnstile-sheets-workers-delete',
  'turnstile-sheets-workers-read', 'turnstile-sheets-workers-write', 'turnstile-sheets-write', 'turnstile-terminal-delete', 'turnstile-terminal-read', 'turnstile-terminal-write',
  'universities-delete', 'universities-write', 'users-delete', 'users-read', 'users-write', 'vacancy-approve-delete',
  'work-day-delete', 'work-day-write',
  'integration-enums', 'integration-dashboard', 'integration-structure', 'integration-leaders', 'integration-departments', 'integration-departments-list', 'integration-positions', 'integration-positions-list', 'integration-kpi', 'integration-classifications', 'integration-contracts', 'integration-workers', 'integration-workers-dashboard', 'integration-workers-pins', 'integration-worker-pin', 'integration-worker-show', 'integration-worker-check', 'integration-worker-events-month', 'integration-worker-events-day', 'integration-turnstile-events', 'integration-station-workers', 'integration-station-worker', 'integration-station-resume', 'integration-station-stats', 'integration-meds', 'integration-worker-meds', 'integration-worker-salary', 'integration-worker-salary-months', 'integration-mobile-face-send-event', 'integration-mobile-face-check-worker', 'integration-mobile-face-schedules', 'integration-otp-verify', 'integration-holiday-greetings',
])
...
export const MEANINGFUL = new Set([
  ...
  'exam-topics-read', 'exam-topics-write', 'export-workers-zip', 'extra', 'extra-worker-user', 'filter-search-workers',
  'holiday-greetings-delete', 'holiday-greetings-read', 'holiday-greetings-write', 'holidays', 'holidays-delete', 'holidays-read',
  'holidays-write', 'hospital', 'hospital-expired', 'hospital-pensioner', 'hospital-pensioner-read', 'hospital-pensioner-write',
  'hospital-ticket', 'hr', 'hr-business-trip', 'hr-business-trip-read', 'hr-business-trip-write', 'hr-check-worker',
  'hr-commands', 'hr-commands-blank', 'hr-commands-delete', 'hr-commands-read', 'hr-commands-write', 'hr-confirmations',
  'hr-confirmations-delete', 'hr-confirmations-read', 'hr-confirmations-write', 'hr-contract-additional', 'hr-contract-additional-delete', 'hr-contract-additional-read',
  'hr-contract-additional-write', 'hr-contracts', 'hr-contracts-delete', 'hr-contracts-read', 'hr-contracts-write', 'hr-dashboard',
  'hr-dashboard-read', 'hr-departments', 'hr-departments-delete', 'hr-departments-read', 'hr-departments-write', 'hr-discips',
  'hr-discips-read', 'hr-documents', 'hr-documents-delete', 'hr-documents-read', 'hr-documents-write', 'hr-edu-plans-read',
  'hr-edu-plans-write', 'hr-export', 'hr-incentives', 'hr-incentives-read', 'hr-incentives-write', 'hr-jobs',
  'hr-jobs-read', 'hr-language-certificates-delete', 'hr-language-certificates-read', 'hr-language-certificates-write', 'hr-leaders', 'hr-leaders-delete',
  'hr-leaders-read', 'hr-leaders-write', 'hr-med', 'hr-med-delete', 'hr-med-read', 'hr-med-write',
  'hr-monthly-report', 'hr-monthly-report-delete', 'hr-organization-phones-delete', 'hr-organization-phones-read', 'hr-organization-phones-write', 'hr-pensioners-delete',
  'hr-pensioners-read', 'hr-pensioners-write', 'hr-polyclinics-delete', 'hr-polyclinics-read', 'hr-polyclinics-write', 'hr-positions',
  'hr-positions-delete', 'hr-positions-read', 'hr-positions-write', 'hr-public-vacancy', 'hr-public-vacancy-delete', 'hr-public-vacancy-read',
  'hr-public-vacancy-write', 'hr-report', 'hr-report-delete', 'hr-report-export', 'hr-report-export-delete', 'hr-report-management-write',
  'hr-report-read', 'hr-report-write', 'hr-table', 'hr-table-delete', 'hr-table-read', 'hr-table-workers',
  'hr-table-workers-read', 'hr-table-workers-write', 'hr-table-write', 'hr-users-read', 'hr-users-write', 'hr-vacation-schedule-delete',
  'hr-vacation-schedule-read', 'hr-vacation-schedule-write', 'hr-vacations', 'hr-vacations-read', 'hr-vacations-write', 'hr-worker-applications',
  'hr-worker-applications-read', 'hr-worker-applications-write', 'hr-workers', 'hr-workers-delete', 'hr-workers-read', 'hr-workers-write',
  'hr-zoom-read', 'instructions', 'instructions-delete', 'instructions-read', 'instructions-write', 'integration',
  'integration-clients-delete', 'integration-clients-read', 'integration-clients-write', 'languages-delete', 'languages-read', 'languages-write',
  'learning-centers', 'learning-centers-delete', 'learning-centers-read', 'learning-centers-write', 'lms', 'lms-certificate',
  'lms-certificate-delete', 'lms-certificate-read', 'lms-certificate-write', 'lms-direction', 'lms-direction-delete', 'lms-direction-read',
  'lms-direction-write', 'lms-edu-plan', 'lms-edu-plan-delete', 'lms-edu-plan-read', 'lms-edu-plan-write', 'lms-groups-read',
  'lms-groups-write', 'lms-lessons', 'lms-lessons-delete', 'lms-lessons-read', 'lms-lessons-write', 'lms-specialization',
  'lms-specialization-delete', 'lms-specialization-read', 'lms-specialization-write', 'lms-subjects', 'lms-subjects-delete', 'lms-subjects-read',
  'lms-subjects-write', 'lms-teachers', 'lms-teachers-delete', 'lms-teachers-read', 'lms-teachers-write', 'lms-worker',
  'lms-worker-read', 'lms-worker-write', 'log-viewer-read', 'mobile-stories-delete', 'mobile-users-read', 'nationalities',
  'nationalities-delete', 'nationalities-read', 'nationalities-write', 'organization-services-write', 'organizations', 'organizations-delete',
  'organizations-read', 'organizations-write', 'permissions', 'permissions-delete', 'permissions-read', 'permissions-write',
  'positions', 'positions-delete', 'positions-read', 'positions-write', 'quotes-delete', 'quotes-write',
  'regions', 'regions-delete', 'regions-read', 'regions-write', 'roles', 'roles-delete',
  'roles-read', 'roles-write', 'schedules', 'schedules-delete', 'schedules-read', 'schedules-write',
  'specialities-delete', 'specialities-read', 'specialities-write', 'telegram', 'telegram-read', 'telegram-write',
  'turnstile', 'turnstile-absent-workers-export', 'turnstile-access-levels', 'turnstile-access-levels-read', 'turnstile-access-levels-write', 'turnstile-approve',
  'turnstile-approve-delete', 'turnstile-approve-read', 'turnstile-approve-write', 'turnstile-building', 'turnstile-building-delete', 'turnstile-building-read',
  'turnstile-building-write', 'turnstile-dashboard', 'turnstile-dashboard-read', 'turnstile-devices', 'turnstile-devices-delete', 'turnstile-devices-read',
  'turnstile-devices-write', 'turnstile-hc-invalid-user', 'turnstile-hc-user-image-logs', 'turnstile-hcp-duration', 'turnstile-hcp-duration-read', 'turnstile-hik-central-events',
  'turnstile-hik-central-events-read', 'turnstile-hik-central-job', 'turnstile-hik-central-job-read', 'turnstile-hik-central-job-write', 'turnstile-hik-central-sync', 'turnstile-hik-central-sync-read',
  'turnstile-hik-central-sync-write', 'turnstile-hik-central-tg-user', 'turnstile-hik-central-tg-user-delete', 'turnstile-hik-central-tg-user-read', 'turnstile-hik-central-tg-user-write', 'turnstile-hik-central-workers',
  'turnstile-hik-central-workers-delete', 'turnstile-hik-central-workers-read', 'turnstile-hik-central-workers-write', 'turnstile-organization', 'turnstile-organization-access-levels', 'turnstile-organization-access-levels-read',
  'turnstile-organization-access-levels-write', 'turnstile-organization-read', 'turnstile-organization-write', 'turnstile-others', 'turnstile-sheets', 'turnstile-sheets-delete',
  'turnstile-sheets-groups', 'turnstile-sheets-groups-delete', 'turnstile-sheets-groups-read', 'turnstile-sheets-groups-write', 'turnstile-sheets-read', 'turnstile-sheets-workers',
  'turnstile-sheets-workers-delete', 'turnstile-sheets-workers-read', 'turnstile-sheets-workers-write', 'turnstile-sheets-write', 'turnstile-terminal', 'turnstile-terminal-delete',
  'turnstile-terminal-read', 'turnstile-terminal-write', 'turnstile-work-duration', 'turnstile-work-duration-read', 'turnstile-worker-image', 'turnstile-workers',
  'turnstile-workers-read', 'turnstile-workers-write', 'universities', 'universities-delete', 'universities-read', 'universities-write',
  'useful', 'users', 'users-delete', 'users-read', 'users-write', 'vacancy-approve-delete',
  'work-day', 'work-day-delete', 'work-day-read', 'work-day-write',
  'integration-enums', 'integration-dashboard', 'integration-structure', 'integration-leaders', 'integration-departments', 'integration-departments-list', 'integration-positions', 'integration-positions-list', 'integration-kpi', 'integration-classifications', 'integration-contracts', 'integration-workers', 'integration-workers-dashboard', 'integration-workers-pins', 'integration-worker-pin', 'integration-worker-show', 'integration-worker-check', 'integration-worker-events-month', 'integration-worker-events-day', 'integration-turnstile-events', 'integration-station-workers', 'integration-station-worker', 'integration-station-resume', 'integration-station-stats', 'integration-meds', 'integration-worker-meds', 'integration-worker-salary', 'integration-worker-salary-months', 'integration-mobile-face-send-event', 'integration-mobile-face-check-worker', 'integration-mobile-face-schedules', 'integration-otp-verify', 'integration-holiday-greetings',
])
...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    groups: [
      ...
      { prefix: 'hr-users', label: 'workerRole.name' },
